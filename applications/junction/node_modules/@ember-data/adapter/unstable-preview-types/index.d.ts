...
/// <reference path="./-private/build-url-mixin.d.ts" />
/// <reference path="./-private/fastboot-interface.d.ts" />
/// <reference path="./-private/utils/parse-response-headers.d.ts" />
/// <reference path="./-private/utils/serialize-query-params.d.ts" />
/// <reference path="./-private/utils/determine-body-promise.d.ts" />
/// <reference path="./-private/utils/continue-on-reject.d.ts" />
/// <reference path="./-private/utils/serialize-into-hash.d.ts" />
/// <reference path="./-private/utils/fetch.d.ts" />
declare module '@ember-data/adapter' {
  ...
  */
  ...
  export { BuildURLMixin } from '@ember-data/adapter/-private';
}
