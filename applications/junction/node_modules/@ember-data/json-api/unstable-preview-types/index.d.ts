...
/// <reference path="./-private/cache.d.ts" />
/// <reference path="./-private/validate-document-fields.d.ts" />
/// <reference path="./-private/serialize.d.ts" />
/// <reference path="./-private/validator/utils.d.ts" />
/// <reference path="./-private/validator/index.d.ts" />
/// <reference path="./-private/validator/1.1/7.1_top-level-document-members.d.ts" />
/// <reference path="./-private/validator/1.1/links.d.ts" />
/// <reference path="./-private/validator/1.1/7.2_resource-objects.d.ts" />
...
/// <reference path="./-private/builders/find-record.type-test.d.ts" />
/// <reference path="./-private/builders/query.type-test.d.ts" />
declare module '@ember-data/json-api' {
  export { default } from '@ember-data/json-api/-private/cache';
  /**
   * <p align="center">
    <img
      class="project-logo"
