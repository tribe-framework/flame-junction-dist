...
declare module '@ember-data/request' {
  export { RequestManager as default } from '@ember-data/request/-private/manager';
  export { createDeferred } from '@ember-data/request/-private/future';
  export type { Future, Handler, CacheHandler, NextFn } from '@ember-data/request/-private/types';
  ...
  export { setPromiseResult, getPromiseResult } from '@ember-data/request/-private/promise-cache';
  export type { Awaitable } from '@ember-data/request/-private/promise-cache';
}
