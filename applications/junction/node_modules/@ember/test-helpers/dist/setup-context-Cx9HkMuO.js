  ...
  return Promise.resolve().then(() => {
      ...
      value(key, value) {
        const ret = run(function () {
          if (ComponentRenderMap.has(context)) {
            assert('You cannot call `this.set` when passing a component to `render()` (the rendered component does not have access to the test context).');
          } else {
    ...
    Object.defineProperty(context, 'setProperties', {
      ...
      value(hash) {
        const ret = run(function () {
          if (ComponentRenderMap.has(context)) {
            assert('You cannot call `this.setProperties` when passing a component to `render()` (the rendered component does not have access to the test context)');
          } else {
...
export { ComponentRenderMap as C, SetUsage as S, _cleanupOnerror as _, setupContext as a, setContext as b, getDeprecations as c, getDeprecationsDuringCallback as d, getWarnings as e, getWarningsDuringCallback as f, getContext as g, setupApplicationContext as h, isTestContext as i, currentRouteName as j, currentURL as k, isSettled as l, getSettledState as m, setupOnerror as n, resetOnerror as o, pauseTest as p, isApplicationTestContext as q, resumeTest as r, settled as s, hasPendingTransitions as t, unsetContext as u, visit as v, setupRouterSettlednessTracking as w, _teardownAJAXHooks as x, _setupAJAXHooks as y, _prepareOnerror as z };
//# sourceMappingURL=setup-context-Cx9HkMuO.js.map
