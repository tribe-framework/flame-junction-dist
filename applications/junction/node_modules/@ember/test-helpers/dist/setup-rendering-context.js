...
import { s as settled, i as isTestContext, g as getContext, C as ComponentRenderMap, S as SetUsage } from './setup-context-Cx9HkMuO.js';
...
function setupRenderingContext(context) {
  ...
  return Promise.resolve().then(() => {
    ...
    if (owner._emberTestHelpersMockOwner) {
      const dispatcher = owner.lookup('event_dispatcher:main') || Ember.EventDispatcher.create();
