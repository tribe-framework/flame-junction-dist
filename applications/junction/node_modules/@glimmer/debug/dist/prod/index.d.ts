...
declare const CheckUndefined: Checker<undefined>;
...
export { debug, debugSlice, logOpcode, buildEnum, buildMetas, buildSingleMeta, META_KIND, normalize, normalizeAll, normalizeParsed, OPERAND_TYPES, strip, opcodeMetadata, check, CheckArray, CheckBlockSymbolTable, CheckBoolean, CheckDict, CheckDocumentFragment, CheckElement, CheckFunction, CheckHandle, CheckInstanceof, CheckInterface, CheckMaybe, CheckNode, CheckNumber, CheckObject, CheckOption, CheckOr, CheckPrimitive, CheckProgramSymbolTable, CheckSafeString, CheckString, CheckUndefined, CheckUnknown, recordStackSize, wrap };
export type { NormalizedMetadata, NormalizedOpcodes, Operand, OperandList, OperandName, OperandType, RawOperandFormat, RawOperandMetadata, Stack, Checker };
