...
var DestroyingState =  function(DestroyingState) {
    return DestroyingState[DestroyingState.Live = 0] = "Live", DestroyingState[DestroyingState.Destroying = 1] = "Destroying", 
    DestroyingState[DestroyingState.Destroyed = 2] = "Destroyed", DestroyingState;
}(DestroyingState || {});
...
function registerDestructor(destroyable, destructor, eager = !1) {
    ...
    let meta = getDestroyableMeta(destroyable), destructorsKey = !0 === eager ? "eagerDestructors" : "destructors";
...
function destroy(destroyable) {
    ...
    meta.state = DestroyingState.Destroying, iterate(children, destroy), iterate(eagerDestructors, (destructor => destructor(destroyable))), 
    ...
    scheduleDestroyed((() => {
        iterate(parents, (parent => function(child, parent) {
            ...
            parentMeta.state === DestroyingState.Live && (parentMeta.children = remove(parentMeta.children, child, DEBUG && "attempted to remove child from parent, but the parent's children did not contain the child. This is likely a bug with destructors."));
