const ContentType = {
    ...
    willDestroy: 2048,
    hasSubOwner: 4096
}, ARG_SHIFT = 8, MAX_SIZE = 2147483647, TYPE_SIZE = 255, TYPE_MASK = 255, OPERAND_LEN_MASK = 768, MACHINE_MASK = 1024, MachineOp = {
    PushFrame: 0,
    PopFrame: 1,
    InvokeVirtual: 2,
    InvokeStatic: 3,
...
const $pc = 0, $ra = 1, $fp = 2, $sp = 3, $s0 = 4, $s1 = 5, $t0 = 6, $t1 = 7, $v0 = 8;

// $1 or $ra (return address): pointer into `program` for the return
let MachineRegister =  function(MachineRegister) {
    return MachineRegister[MachineRegister.pc = 0] = "pc", MachineRegister[MachineRegister.ra = 1] = "ra", 
    MachineRegister[MachineRegister.fp = 2] = "fp", MachineRegister[MachineRegister.sp = 3] = "sp", 
    MachineRegister;
}({});
...
let SavedRegister =  function(SavedRegister) {
    return SavedRegister[SavedRegister.s0 = 4] = "s0", SavedRegister[SavedRegister.s1 = 5] = "s1", 
    SavedRegister;
}({}), TemporaryRegister =  function(TemporaryRegister) {
    return TemporaryRegister[TemporaryRegister.t0 = 6] = "t0", TemporaryRegister[TemporaryRegister.t1 = 7] = "t1", 
    TemporaryRegister;
}({});
