declare module '@warp-drive/core-types/symbols' {
  export const RecordStore: '___(unique) Symbol(Store)';
  /**
   ...
   * @typedoc
   */
  export const Type: '___(unique) Symbol($type)';
  /**
   ...
   * @typedoc
   */
  export const ResourceType: '___(unique) Symbol($type)';
  /**
   ...
   * @typedoc
   */
  export const TransformName: '___(unique) Symbol($type)';
  /**
   ...
   * @typedoc
   */
  export const RequestSignature: '___(unique) Symbol(RequestSignature)';
}
