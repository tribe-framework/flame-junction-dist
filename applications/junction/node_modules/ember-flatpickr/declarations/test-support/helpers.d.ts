 ...
 */
export function isFlatpickrOpen(pickrIndex?: number | undefined): boolean;
/**
 ...
 */
export function setFlatpickrDate(selector: string, date: Object, triggerChange?: boolean | undefined): void;
/**
 * @param {String} selector - CSS3 selector of the element to pull the flatpickr instance from
