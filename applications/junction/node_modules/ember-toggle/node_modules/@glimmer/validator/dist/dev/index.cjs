...
if (env.DEBUG) {
  ...
  debug.markTagAsConsumed = _tag => {
    ...
    CONSUMED_TAGS.set(_tag, util.getLast(util.asPresentArray(TRANSACTION_STACK)));
...
class MonomorphicTagImpl {
  ...
  static updateTag(_tag, _subtag) {
    if (env.DEBUG && _tag[TYPE] !== UPDATABLE_TAG_ID) {
  ...
  static dirtyTag(tag, disableConsumptionAssertion) {
    if (env.DEBUG && !(tag[TYPE] === UPDATABLE_TAG_ID || tag[TYPE] === DIRYTABLE_TAG_ID)) {
