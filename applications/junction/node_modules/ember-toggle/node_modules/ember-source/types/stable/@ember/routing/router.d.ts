declare module '@ember/routing/router' {
  ...
  import { default as BucketCache } from '@ember/routing/lib/cache';
  import { default as DSL, type DSLCallback } from '@ember/routing/lib/dsl';
  import RouterState from '@ember/routing/lib/router_state';
  ...
  import { type QueryParamMeta, type default as Route } from '@ember/routing/route';
  import type {
    InternalRouteInfo,
    ModelFor,
    RouteInfo,
