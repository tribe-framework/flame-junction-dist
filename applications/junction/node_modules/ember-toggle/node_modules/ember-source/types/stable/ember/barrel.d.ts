declare module 'ember/barrel' {
  ...
  namespace Ember {
    ...
    const _componentManagerCapabilities: typeof componentCapabilities;
    const _modifierManagerCapabilities: typeof modifierCapabilities;
    const meta: {
    ...
    const assert: import('@ember/debug/lib/assert').AssertFunc;
